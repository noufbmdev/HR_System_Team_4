<h1 class="title">عقد عمل موظف سعودي</h1>

<p>تم إبرام هذا العقد يوم الأحد << <greg_date>> هجريًا الموافق << <contract_date> >> ميلادي بين كل من:</p>

<table>
    <tbody>
        <tr>
            <td style="width: 10%">الأول الطرف</td>
            <td style="width: 90%">الجمعية السعودية لاضطراب فرط الحركة وتشتت الانتباه المسجلة بوزارة العمل والتنمية الاجتماعية بترخيص رقم ٤٧٤ وعنوانها ص.ب. ٩٤٠٣٧ الرمز البريدي ١١٦٩٣ الرياض، ويمثلها في هذا العقد المدير التنفيذي الأستاذة نوال بنت محمد الشريف. </td>
        </tr>
        <tr>
            <td style="width: 10%">الطرف الثاني:</td>
            <td style="width: 90%">اسم الموظف <<<full_name>>الجنس <<<Sex>>> الجنسية <<<Nationality>>>بموجب بطاقة الهوية الوطنية رقم <<<NationalID>>> مصدرها <<<CIty>>> تاريخها ‏06‏/04‏/1441‏هـوعنوانه <<<Street>>>، <<<Neborhood>>>هاتف رقم <<<MobileNo>>></td>
        </tr>
    </tbody>
</table>
...
<ul>
    <li>‌يقــر الطـــرف الثــاني أنـه بنـاء علــى طلبـــه ومـــوافقة الطــــرف الأول قبــل العمــل لــدى الطـــرف الأول وتحــت إدارتــه وإشـرافـــه بوظيفة	<<<Job>>>	في مدينة	الرياض	أو بأي جهة أخرى يمارس فيها الطرف الأول نشاطه داخل المملكة وأن يقوم بكافة</li>
...
‌أ.	يستحق الطرف الثاني راتباً أساسياً مقـــــــــــــــــداره (<<<Allowance>>>) ريال، وبدل سكن شهري مقداره (<<<Housing>>>) ريال، وبدل نقل مقداره (<<<Transpot>>>) ريال. ويلتزم الطرف الأول بتسليم راتب الموظف كاملاً عند نهاية كلّ شهر ميلادي.<br/>
