          ...
          <div class="col-sm-6">
            ...
            <div class="col-sm-6">
                ...
                <select class="form-control" name="departmenId">
                  ...
                  ?>
                        <option <?php if($depatment['Department_ID'] == $contract['Department_ID']){ echo 'selected'; } ?> value="<?php echo $depatment['Department_ID'] ?>"><?php echo $depatment['Name']; ?></option>
                  <?php
                      }
                    }
                  ?>
                ...
                <select class="form-control" name="managerID">
                  ...
                  ?>
                        <option <?php if($manager['ID'] == $contract['Manager_ID']){ echo 'selected'; } ?> value="<?php echo $manager['ID'] ?>"><?php echo $manager['Employee_ID']; ?></option>
                  <?php
                      }
                    }
                  ?>
                ...
                <select class="form-control" name="role">
                  ...
                  ?>
                        <option <?php if($role['id'] == $contract['Role']){ echo 'selected'; } ?> value="<?php echo $role['id'] ?>"><?php echo $role['role_name']; ?></option>
                  <?php
                      }
                    }
                  ?>
