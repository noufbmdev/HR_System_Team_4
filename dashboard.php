      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <div class="row text-center" style="margin-bottom: 10px;">
              <h4><strong>مرحبا بك <?php echo $_SESSION["username"];?><br/>اضغط هنا لتسجيل حضورك</strong></h4>
              <a href="attendance_new.php" class="btn btn-primary">الذهاب لتسجيل الحضور</a>
          </div>

            <div class="row">
              <div class="panel" style="background: #e7eaf0;padding-bottom:10px;">
                <div class="panel-heading">عدد ايام الاجازة المتبقيه</div>
            ...
            <div class="row" style="background: #323376;">
              <h4 style="text-align: center; color: #fff;">طلبات الاجازات المقبولة <?php echo $numberOfLeavesTaken; ?></h4>
            </div>
          <div class="row">
            <!-- Carousel container -->
          ...
          <table data-id="flexbox-bar-graph" class="dashboard-table" style="background: #323376;  border-radius: 15px;">
              ...
              ?>
              <caption style="color: #fff;">اسبوع العمل<br/>من <?php echo $this_week_sd; ?> الى <?php echo $this_week_ed; ?></caption>
